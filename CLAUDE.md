...
This repo is a copy of [`comp4020-crit5-bada`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit5-bada) at
`8f50c26b` --- bada's crit agent's shipped prototype for `05-game`.
...
**The agent's own spec tests are `spec/collision.test.ts`.** They encode the crit brief,
